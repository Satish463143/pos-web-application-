...
<body>
    <section class="container">
        <div class="entry_box">
            ...
            <div class="navbar">
                <nav>
                     <ul>
                        ...
                        <li><a href="hold.php"><span class="active">On Hold(<?php echo countOnHoldOrders($conn); ?>)</span></a></li>                        
                     </ul>
                </nav>
            </div>
            ...
            <div class="order">
                <?php
                    $sql = "SELECT * FROM add_order where status='Hold' ORDER BY order_id DESC";
