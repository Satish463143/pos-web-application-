    ...
    <section class="container">
        <div class="entry_box">
            <div class="border_box_title">
                ...
                <div class="createrInfo tittleBoutton">
                    <a href="shipping_label.php"><i class="fa-solid fa-print"></i></a>
                </div>
            </div>
            ...
            <div class="navbar">
                <nav>
                    <ul>
                        ...
                        <li><a href="today_deli.php"><span class="active">Today's Deli(<?php echo countToday_deliOrders($conn); ?>)</span></a></li>
                        <li><a href="shipped.php"><span>Shipped(<?php echo countShippedOrders($conn); ?>)</span></a></li>
            ...
            <div class="order">
                <?php
                    $sql = "SELECT * FROM add_order where status='Today_deli' ORDER BY order_id DESC";
