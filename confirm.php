...
<body>
    <section class="container">
        <div class="entry_box">
            ...
            <div class="navbar">
                <nav>
                    <ul>
                        ...
                        <li><a href="confirm.php"><span class="active">Confirmed(<?php echo countConfirmedOrders($conn); ?>)</span></a></li>
            ...
            <div class="order">
                <?php
                    $sql = "SELECT * FROM add_order where status='Confirmed' ORDER BY order_id DESC";
