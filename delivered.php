...
<body>
    <section class="container">
        <div class="entry_box">
            ...
            <div class="navbar">
                <nav>
                    <ul>
                        ...
                        <li><a href="delivered.php"><span class="active">Delivered(<?php echo countDeliveredOrders($conn); ?>)</span></a></li>
            ...
            <div class="order">
                <?php
                    $sql = "SELECT * FROM add_order where status='Delivered' ORDER BY order_id DESC";
