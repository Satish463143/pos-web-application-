    ...
    <section class="container">
        <div class="entry_box">
            ...
            <div class="navbar">
                <nav>
                    <ul>
                        <li><a href="order.php"><span class="active">Pending(<?php echo countPendingOrders($conn); ?>)</span></a></li>
            ...
            <div class="order">
                <?php
                    ...
                    $sql = "SELECT * FROM add_order where status='Pending' ORDER BY order_id DESC";
