...
<body>
    <section class="container">
        <div class="entry_box">
            ...
            <div class="navbar">
                <nav>
                    <ul>
                        ...
                        <li><a href="cancle.php"><span class="active">Cancle(<?php echo countCancleOrders($conn); ?>)</span></a></li>
            ...
            <div class="order">
                <?php
                    $sql = "SELECT * FROM add_order where status='Cancle' ORDER BY order_id DESC";
